...
SECRET_KEY = "!ed_3!5*v+$m@m@n=+#7fhc$=$2jp2iv!duykq7x-x((*@*jkg"
...
CORS_ORIGIN_WHITELIST = ["http://localhost:3000", "http://192.168.43.127:3000"]
CORS_ORIGIN_REDEX_WHITELIST = ["http://localhost:3000"]
